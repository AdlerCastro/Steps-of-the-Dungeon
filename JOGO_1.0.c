	...
	i = getch();
		...
		switch(i){
		        ...
		        case 'i':
		        	...
		        	//usar a chave 1 na porta
		        	if(mapa[py - 1][px]  == mapa[L][C] || mapa[py][px - 1]  == mapa[3][5] || mapa[py + 1][px]  == mapa[3][5] || mapa[py][px + 1]  == mapa[3][5]){
		        		if(mapa[1][2] = ' '){
							mapa[3][5] = '=';
						}
						else{
					...
					*/
					//chave 1
					if(mapa[px - 1][py]  == mapa[1][10] || mapa[px][py - 1]  == mapa[1][10] || mapa[px + 1][py]  == mapa[1][10] || mapa[px][py + 1]  == mapa[1][10]){
		        		mapa[1][10] = ' ';
					}
					//usar a chave 1 na porta
